/* asset.h -- AAssetManager NDK emulation over the loose APK assets
 *
 * This software may be modified and distributed under the terms
 * of the MIT license. See the LICENSE file for details.
 *
 * The Android build keeps the game data in the APK's assets/ folder
 * (resources.bin, 001.dat..008.dat, Shaders/, build_date.txt). the Android runner reads
 * them through the NDK AAsset API and through the runner's file layerAndroid, which both
 ...
 * archives are parsed (and any per-file obfuscation undone) inside libyoyo.so.
 */
...
// absolute folder the loose assets are served from (default: relative "assets")
