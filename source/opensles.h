 ...
 * backed by a single software-mixed libnx audout device.
 *
...
// FMV audio ring (movie_player.c), mixed into audout beside the engine.
...
// interface-id tokens referenced by libyoyo.so relocations: each a unique
