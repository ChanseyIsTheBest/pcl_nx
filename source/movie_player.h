/* movie_player.h -- video playback API (stubbed: Pocket Crystal League has no video)
 *
...
// Register the engine's GL state-cache reset (must be resolved at boot, before
